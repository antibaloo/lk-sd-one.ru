                ...
                <div class="d-flex flex-wrap justify-content-center justify-content-md-start">
                    <div id="slick_drill">
                        <div class="el-up item">
                            ...
                            <div class="field-title d-flex align-items-center justify-content-center justify-content-lg-between">
                                <span>SN 10001</span>
    ...
    <div class="container position-relative">
        <div class="tabs-wrapper" id="tabs-wr-1">
                        ...
                        <div class="col-filters col-auto d-flex align-items-center">
                            ...
                            <div class="filter-btns flex-wrap">
                                <div class="col-auto col-filter-item">
                                    <button class="btn-filter btn btn-primary active" data-name="1day">Сегодня</button>
                                </div>
                                <div class="col-auto col-filter-item">
                        ...
                        <div class="col-auto d-flex align-items-center col-date-period">
                            <div class="filter-dates d-flex flex-wrap align-items-center py-2 ps-4 pe-5">
                                ...
                                <input type="text" class="filter-date filter-date-end" id="filter-date-end"
                                       placeholder="дд-мм-гггг чч:мм" value="">
                                <input type="text" class="filter-date filter-date-end-iso d-none" id="filter-date-end-iso"
                                       placeholder="дд-мм-гггг чч:мм" value="">
                                <button id="filter-date-submit" class="filter-date-submit position-absolute border-0 rounded-circle">
                                    Применить
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="charts-tpl">
                            ...
                            <div class="tabs-wrapper" id="tabs-wr-2">
                                ...
                                <div class="tab-item" id="tab-toplivo">
                                    <div class="custom-charts-pie d-flex flex-wrap justify-content-center">
                                        <div id="myChart_fuel-wrapper" class="chart--container loaded"></div>
                                    </div>
                                </div>
            ...
            <div class="tab-item active" id="tab-monitoring">
                    ...
                    <div class="row justify-content-between">
                        <div class="col-filters col-auto d-flex align-items-center">
                            ...
                            <div class="filter-btns flex-wrap">
                                ...
                                <div class="col-auto col-filter-item">
                                    <button class="btn-filter btn btn-primary active" data-name="1day">1 день</button>
                                </div>
                            </div>
                        </div>
                        <button class="m-btn-filter btn btn-primary active-2">
                ...
                <div class="block-title text-center mb-4 fw-bold"><span class="fw-bolder">Сводные диаграммы</span></div>
                <!--tabs-->
                ...
                <!--tabs end-->
                <div class="block-title text-center mb-3 mb-sm-4 mt-3 mt-sm-5 pt-3 fw-bold"><span class="fw-bolder">Исходные диаграммы с группировкой</span>
                </div>
                <!--tabs-->
                <div class="tabs row justify-content-center fw-bold mb-3">
                    <div class="col-auto mb-2">
...
<script src="https://api-maps.yandex.ru/2.1/?apikey=f2a56c6c-f460-4ec0-89df-99063b786797&lang=ru_RU"
